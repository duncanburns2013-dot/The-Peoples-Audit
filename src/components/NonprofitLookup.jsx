...
export default function NonprofitLookup() {
  ...
  const getTopNonprofits = () => {
    if (nonprofitDb.current) {
      // Return top 10 by revenue from the real data
      return [...nonprofitDb.current]
        .filter((o) => o.income_amount > 0)
        .sort((a, b) => (b.income_amount || 0) - (a.income_amount || 0))
        .slice(0, 10)
        .map((o) => ({ name: o.name, ein: o.ein, revenue: o.income_amount, city: o.city }));
    }
