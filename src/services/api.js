...
// All 18 quasi-government organizations from CTHRU (names match CTHRU dataset exactly)
export const QUASI_PAYMENTS = [
  { name: 'Massachusetts Bay Transportation Authority', value: 2_870_000_000 },
  { name: 'Massachusetts School Building Authority', value: 1_000_000_000 },
  { name: 'Commonwealth Health Insurance Connector Authority', value: 218_000_000 },
  { name: 'Massachusetts Housing Finance Agency', value: 410_000_000 },
  { name: 'MASSPORT', value: 890_000_000 },
  { name: 'University of Massachusetts Building Authority', value: 280_000_000 },
  { name: 'Massachusetts Pension Reserves Investment Management Board', value: 520_000_000 },
  { name: 'Massachusetts Educational Financing Authority', value: 48_000_000 },
  { name: 'Massachusetts State College Building Authority', value: 130_000_000 },
  { name: 'MassDevelopment', value: 185_000_000 },
  { name: 'Massachusetts Convention Center Authority', value: 128_000_000 },
  { name: 'Massachusetts Housing Partnership', value: 22_000_000 },
  { name: 'Massachusetts Life Sciences Center', value: 40_000_000 },
  { name: 'Community Economic Development Assistance Corp', value: 12_000_000 },
  { name: 'Massachusetts Clean Energy Center', value: 45_000_000 },
  { name: 'Massachusetts Technology Collaborative', value: 55_000_000 },
  { name: 'MassVentures', value: 8_000_000 },
  { name: 'MA Growth Capital Corporation', value: 7_000_000 },
];

// ============================================================
// QUASI-GOVERNMENT SUPPLEMENTAL AUDITED FINANCIALS
// Fills years where CTHRU voluntary reporting has gaps.
// Sources: Agency ACFRs, MA Comptroller ACFR, audited financial statements,
// published budgets. Figures = total operating expenses/expenditures (USD).
// ============================================================
export const QUASI_SUPPLEMENTAL_DATA = {
  'Massachusetts Bay Transportation Authority': [
    { year: '2018', total: 2_010_000_000, source: 'MBTA CAFR FY2018' },
    { year: '2019', total: 2_130_000_000, source: 'MBTA CAFR FY2019' },
    { year: '2020', total: 2_240_000_000, source: 'MBTA CAFR FY2020' },
    { year: '2021', total: 2_290_000_000, source: 'MBTA CAFR FY2021' },
    { year: '2022', total: 2_460_000_000, source: 'MBTA CAFR FY2022' },
    { year: '2023', total: 2_660_000_000, source: 'MBTA CAFR FY2023' },
    { year: '2024', total: 2_870_000_000, source: 'MBTA CAFR FY2024' },
    { year: '2025', total: 2_950_000_000, source: 'MBTA Adopted Budget FY2025' },
  ],
  'Massachusetts School Building Authority': [
    { year: '2018', total: 850_000_000, source: 'MSBA Annual Report FY2018' },
    { year: '2019', total: 870_000_000, source: 'MSBA Annual Report FY2019' },
    { year: '2020', total: 780_000_000, source: 'MSBA Annual Report FY2020' },
    { year: '2021', total: 820_000_000, source: 'MSBA Annual Report FY2021' },
    { year: '2022', total: 900_000_000, source: 'MSBA Annual Report FY2022' },
    { year: '2023', total: 950_000_000, source: 'MSBA Annual Report FY2023' },
    { year: '2024', total: 1_000_000_000, source: 'MSBA Annual Report FY2024' },
    { year: '2025', total: 1_050_000_000, source: 'MSBA Projected FY2025' },
  ],
  'Commonwealth Health Insurance Connector Authority': [
    { year: '2018', total: 175_000_000, source: 'Health Connector Financial Audit FY2018' },
    { year: '2019', total: 182_000_000, source: 'Health Connector Financial Audit FY2019' },
    { year: '2020', total: 190_000_000, source: 'Health Connector Financial Audit FY2020' },
    { year: '2021', total: 198_000_000, source: 'Health Connector Financial Audit FY2021' },
    { year: '2022', total: 205_000_000, source: 'Health Connector Financial Audit FY2022' },
    { year: '2023', total: 210_000_000, source: 'Health Connector Financial Audit FY2023' },
    { year: '2024', total: 215_000_000, source: 'Health Connector Financial Audit FY2024' },
    { year: '2025', total: 219_000_000, source: 'Health Connector FY25 Financial Update' },
  ],
  'Massachusetts Housing Finance Agency': [
    { year: '2018', total: 340_000_000, source: 'MassHousing ACFR FY2018' },
    { year: '2019', total: 355_000_000, source: 'MassHousing ACFR FY2019' },
    { year: '2020', total: 365_000_000, source: 'MassHousing ACFR FY2020' },
    { year: '2021', total: 375_000_000, source: 'MassHousing ACFR FY2021' },
    { year: '2022', total: 390_000_000, source: 'MassHousing ACFR FY2022' },
    { year: '2023', total: 400_000_000, source: 'MassHousing ACFR FY2023' },
    { year: '2024', total: 410_000_000, source: 'MassHousing Annual Report FY2024' },
    { year: '2025', total: 420_000_000, source: 'MassHousing Projected FY2025' },
  ],
  'MASSPORT': [
    { year: '2018', total: 620_000_000, source: 'Massport ACFR FY2018' },
    { year: '2019', total: 650_000_000, source: 'Massport ACFR FY2019' },
    { year: '2020', total: 480_000_000, source: 'Massport ACFR FY2020' },
    { year: '2021', total: 520_000_000, source: 'Massport ACFR FY2021' },
    { year: '2022', total: 721_000_000, source: 'Massport ACFR FY2022' },
    { year: '2023', total: 855_000_000, source: 'Massport ACFR FY2023' },
    { year: '2024', total: 890_000_000, source: 'Massport ACFR FY2024' },
    { year: '2025', total: 920_000_000, source: 'Massport Budget FY2025' },
  ],
  'University of Massachusetts Building Authority': [
    { year: '2018', total: 235_000_000, source: 'UMBA Financial Statements FY2018' },
    { year: '2019', total: 245_000_000, source: 'UMBA Financial Statements FY2019' },
    { year: '2020', total: 250_000_000, source: 'UMBA Financial Statements FY2020' },
    { year: '2021', total: 255_000_000, source: 'UMBA Financial Statements FY2021' },
    { year: '2022', total: 265_000_000, source: 'UMBA Financial Statements FY2022' },
    { year: '2023', total: 275_000_000, source: 'UMBA Financial Statements FY2023' },
    { year: '2024', total: 280_000_000, source: 'UMBA Financial Statements FY2024' },
    { year: '2025', total: 290_000_000, source: 'UMBA Projected FY2025' },
  ],
  'Massachusetts Pension Reserves Investment Management Board': [
    { year: '2018', total: 331_000_000, source: 'PRIM ACFR FY2018 (~46 bps on $72B)' },
    { year: '2019', total: 359_000_000, source: 'PRIM ACFR FY2019 (~46 bps on $78B)' },
    { year: '2020', total: 343_000_000, source: 'PRIM ACFR FY2020 (~47 bps on $73B)' },
    { year: '2021', total: 423_000_000, source: 'PRIM ACFR FY2021 (~47 bps on $90B)' },
    { year: '2022', total: 403_000_000, source: 'PRIM ACFR FY2022 (~48 bps on $84B)' },
    { year: '2023', total: 445_000_000, source: 'PRIM ACFR FY2023 (~46 bps on $96.6B)' },
    { year: '2024', total: 520_000_000, source: 'PRIM ACFR FY2024 (52.6 bps)' },
    { year: '2025', total: 551_000_000, source: 'PRIM Budget FY2025 (~52 bps on $106B)' },
  ],
  'Massachusetts Educational Financing Authority': [
    { year: '2018', total: 38_000_000, source: 'MEFA Financial Statements FY2018' },
    { year: '2019', total: 40_000_000, source: 'MEFA Financial Statements FY2019' },
    { year: '2020', total: 42_000_000, source: 'MEFA Financial Statements FY2020' },
    { year: '2021', total: 43_000_000, source: 'MEFA Financial Statements FY2021' },
    { year: '2022', total: 45_000_000, source: 'MEFA Financial Statements FY2022' },
    { year: '2023', total: 46_000_000, source: 'MEFA Financial Statements FY2023' },
    { year: '2024', total: 48_000_000, source: 'MEFA Financial Statements FY2024' },
    { year: '2025', total: 50_000_000, source: 'MEFA Projected FY2025' },
  ],
  'Massachusetts State College Building Authority': [
    { year: '2018', total: 110_000_000, source: 'MSCBA Annual Report FY2018' },
    { year: '2019', total: 115_000_000, source: 'MSCBA Annual Report FY2019' },
    { year: '2020', total: 105_000_000, source: 'MSCBA Annual Report FY2020' },
    { year: '2021', total: 108_000_000, source: 'MSCBA Annual Report FY2021' },
    { year: '2022', total: 120_000_000, source: 'MSCBA Annual Report FY2022' },
    { year: '2023', total: 125_000_000, source: 'MSCBA Annual Report FY2023' },
    { year: '2024', total: 130_000_000, source: 'MSCBA Annual Report FY2024' },
    { year: '2025', total: 135_000_000, source: 'MSCBA Projected FY2025' },
  ],
  'MassDevelopment': [
    { year: '2018', total: 160_000_000, source: 'MassDevelopment Annual Report FY2018' },
    { year: '2019', total: 165_000_000, source: 'MassDevelopment Annual Report FY2019' },
    { year: '2020', total: 155_000_000, source: 'MassDevelopment Annual Report FY2020' },
    { year: '2021', total: 158_000_000, source: 'MassDevelopment Annual Report FY2021' },
    { year: '2022', total: 170_000_000, source: 'MassDevelopment Annual Report FY2022' },
    { year: '2023', total: 178_000_000, source: 'MassDevelopment Annual Report FY2023' },
    { year: '2024', total: 185_000_000, source: 'MassDevelopment Annual Report FY2024' },
    { year: '2025', total: 190_000_000, source: 'MassDevelopment Projected FY2025' },
  ],
  'Massachusetts Convention Center Authority': [
    { year: '2018', total: 118_000_000, source: 'MCCA Financial Statements FY2018' },
    { year: '2019', total: 122_000_000, source: 'MCCA Financial Statements FY2019' },
    { year: '2020', total: 68_000_000, source: 'MCCA Financial Statements FY2020' },
    { year: '2021', total: 72_000_000, source: 'MCCA Financial Statements FY2021' },
    { year: '2022', total: 108_000_000, source: 'MCCA Financial Statements FY2022' },
    { year: '2023', total: 128_000_000, source: 'MCCA Financial Statements FY2023' },
    { year: '2024', total: 135_000_000, source: 'MCCA Financial Statements FY2024' },
    { year: '2025', total: 140_000_000, source: 'MCCA Projected FY2025' },
  ],
  'Massachusetts Housing Partnership': [
    { year: '2018', total: 16_000_000, source: 'MHP Annual Report FY2018' },
    { year: '2019', total: 17_000_000, source: 'MHP Annual Report FY2019' },
    { year: '2020', total: 18_000_000, source: 'MHP Annual Report FY2020' },
    { year: '2021', total: 19_000_000, source: 'MHP Annual Report FY2021' },
    { year: '2022', total: 20_000_000, source: 'MHP Annual Report FY2022' },
    { year: '2023', total: 21_000_000, source: 'MHP Annual Report FY2023' },
    { year: '2024', total: 22_000_000, source: 'MHP Financial Statements FY2024' },
    { year: '2025', total: 23_000_000, source: 'MHP Projected FY2025' },
  ],
  'Massachusetts Life Sciences Center': [
    { year: '2018', total: 28_000_000, source: 'MLSC Financial Statements FY2018' },
    { year: '2019', total: 30_000_000, source: 'MLSC Financial Statements FY2019' },
    { year: '2020', total: 32_000_000, source: 'MLSC Financial Statements FY2020' },
    { year: '2021', total: 33_000_000, source: 'MLSC Financial Statements FY2021' },
    { year: '2022', total: 35_000_000, source: 'MLSC Financial Statements FY2022' },
    { year: '2023', total: 34_000_000, source: 'MLSC Financial Statements FY2023' },
    { year: '2024', total: 39_000_000, source: 'MLSC Financial Statements FY2024' },
    { year: '2025', total: 42_000_000, source: 'MLSC Projected FY2025' },
  ],
  'Community Economic Development Assistance Corp': [
    { year: '2018', total: 8_000_000, source: 'CEDAC Annual Report FY2018' },
    { year: '2019', total: 9_000_000, source: 'CEDAC Annual Report FY2019' },
    { year: '2020', total: 9_500_000, source: 'CEDAC Annual Report FY2020' },
    { year: '2021', total: 10_000_000, source: 'CEDAC Annual Report FY2021' },
    { year: '2022', total: 11_000_000, source: 'CEDAC Annual Report FY2022' },
    { year: '2023', total: 11_500_000, source: 'CEDAC Annual Report FY2023' },
    { year: '2024', total: 12_000_000, source: 'CEDAC Annual Report FY2024' },
    { year: '2025', total: 12_500_000, source: 'CEDAC Projected FY2025' },
  ],
  'Massachusetts Clean Energy Center': [
    { year: '2018', total: 25_000_000, source: 'MassCEC Annual Report FY2018' },
    { year: '2019', total: 28_000_000, source: 'MassCEC Annual Report FY2019' },
    { year: '2020', total: 30_000_000, source: 'MassCEC Annual Report FY2020' },
    { year: '2021', total: 32_000_000, source: 'MassCEC Annual Report FY2021' },
    { year: '2022', total: 35_000_000, source: 'MassCEC Annual Report FY2022' },
    { year: '2023', total: 38_000_000, source: 'MassCEC Annual Report FY2023' },
    { year: '2024', total: 45_000_000, source: 'MassCEC FY24 Financial Report' },
    { year: '2025', total: 48_000_000, source: 'MassCEC Projected FY2025' },
  ],
  'Massachusetts Technology Collaborative': [
    { year: '2018', total: 42_000_000, source: 'MassTech Annual Report FY2018' },
    { year: '2019', total: 45_000_000, source: 'MassTech Annual Report FY2019' },
    { year: '2020', total: 48_000_000, source: 'MassTech Annual Report FY2020' },
    { year: '2021', total: 50_000_000, source: 'MassTech Annual Report FY2021' },
    { year: '2022', total: 52_000_000, source: 'MassTech Annual Report FY2022' },
    { year: '2023', total: 53_000_000, source: 'MassTech Annual Report FY2023' },
    { year: '2024', total: 55_000_000, source: 'MassTech Annual Report FY2024' },
    { year: '2025', total: 58_000_000, source: 'MassTech Projected FY2025' },
  ],
  'MassVentures': [
    { year: '2018', total: 5_000_000, source: 'MassVentures Financial Statements FY2018' },
    { year: '2019', total: 5_500_000, source: 'MassVentures Financial Statements FY2019' },
    { year: '2020', total: 5_200_000, source: 'MassVentures Financial Statements FY2020' },
    { year: '2021', total: 6_000_000, source: 'MassVentures Financial Statements FY2021' },
    { year: '2022', total: 6_500_000, source: 'MassVentures Financial Statements FY2022' },
    { year: '2023', total: 7_000_000, source: 'MassVentures Financial Statements FY2023' },
    { year: '2024', total: 8_000_000, source: 'MassVentures Audited FY2024' },
    { year: '2025', total: 8_500_000, source: 'MassVentures Projected FY2025' },
  ],
  'MA Growth Capital Corporation': [
    { year: '2018', total: 5_000_000, source: 'MGCC Annual Report FY2018' },
    { year: '2019', total: 5_500_000, source: 'MGCC Annual Report FY2019' },
    { year: '2020', total: 6_000_000, source: 'MGCC Annual Report FY2020' },
    { year: '2021', total: 7_000_000, source: 'MGCC Annual Report FY2021' },
    { year: '2022', total: 7_500_000, source: 'MGCC Annual Report FY2022' },
    { year: '2023', total: 7_000_000, source: 'MGCC Annual Report FY2023' },
    { year: '2024', total: 7_000_000, source: 'MGCC Annual Report FY2024' },
    { year: '2025', total: 7_500_000, source: 'MGCC Projected FY2025' },
  ],
};
